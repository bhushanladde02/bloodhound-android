    	...
    	image5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(l!=-1){
	            	...
	            	//new HttpAsyncTask().execute("http://192.168.42.174:8080/BloodHoundBackend/UploadServlet");//(bhushan local system- check ip of system everytime)
...
public static String POST(String url, Register register){
    ...
    try {
        ...
        jsonObject.accumulate("imgURL", register.getImgurl());
      ...
      /*  
        ...
        httpPost.setEntity(reqEntity);*/
        	    ...
        	    // HttpPost        post   = new HttpPost( url );
        	     ...
        	     entity.addPart( "name", new StringBody( name, "text/plain", 
        	                                                Charset.forName( "UTF-8" )));
        	     // For usual String parameters
        	     entity.addPart( "filename", new StringBody(selectedImagePath, "text/plain", 
        	                                                Charset.forName( "UTF-8" )));
